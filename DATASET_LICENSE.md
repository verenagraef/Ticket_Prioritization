...
This repository uses and redistributes the following dataset:
...
The dataset is attributed to Tobias Bueck and is redistributed under the terms of CC BY 4.0.
...
The original dataset license remains applicable to the source material. The repository's MIT code license does not replace or override CC BY 4.0 for the dataset or its licensed source content.
